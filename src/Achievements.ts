...
export const areward = (i: number): string => {
    ...
    const descs: {[key: number]: string} = {
        ...
        187: `Gain an Ascension count multiplier based on your score: x${format(Math.log(metaData[3]) / Math.log(10) - 1)}. Also: Offerings +${format(Math.min(100, player.ascensionCount / 10000), 2)}% [Max: 100% at 1M Ascensions]`,
